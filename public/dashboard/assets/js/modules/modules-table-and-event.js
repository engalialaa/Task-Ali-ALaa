...
$(".company-feed-scroll").mCustomScrollbar({
  axis:"y", // vertical and horizontal scrollbar
  autoHideScrollbar:true,
  setHeight: 500
});
...
$(".active-company .active-company-body .a-t-scroll").mCustomScrollbar({
  axis:"yx", // vertical and horizontal scrollbar
  autoHideScrollbar:true,
  setHeight: 509
});

$(".company-feedback-list .company-feedback-list-body .c-f-l-scroll").mCustomScrollbar({
  axis:"yx", // vertical and horizontal scrollbar
  autoHideScrollbar:true,
  setHeight: 595
});
...
$(".tasks .tasks-body .company-scroll").mCustomScrollbar({
  axis:"y", // vertical and horizontal scrollbar
  autoHideScrollbar:true,
  setHeight: 514
});
...
$(".company #month").html(monthNames[d.getMonth()] + '.');
$(".company #day").html(d.getDate() + '.');
$(".company #year").html(d.getFullYear() + '');
