                  ...
                  <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <form  action="{{url('companies/'.$data->id)}}"  method="POST" class="needs-validation" novalidate  enctype="multipart/form-data">
                              @csrf
                              {{ method_field('PUT') }}
                              <input type="hidden" name="id" value="{{ $data->id }}">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="address" value="{{ $data->address }}" class="form-control" id="validationCustom01" placeholder="Address" value="Mark" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input class="form-control image" name="image" value="{{$data->image}}" type="file">
                                        <div class="invalid-feedback">
